        ...
        <div className="flex flex-col md:flex-row mt-6 px-2 sm:px-10 lg:px-28">
          ...
          <div className="my-auto">
            <div className="flex items-center text-lg text-left mt-8 md:mt-0">
              ...
              <p>Grow your own business or start consulting for others</p>
            </div>
            <div className="flex items-center text-lg text-left mt-3 md:mt-9">
              <div className="text-3xl sm:text-5xl mr-2">
                <FaCheckCircle className="" />
              </div>
              <p>200+ Hours of Content</p>
            </div>
            {/* <div className="flex items-center text-lg text-left mt-3 md:mt-9">
              <div className="text-3xl sm:text-5xl mr-2">
                <FaCheckCircle className="" />
              </div>
              <p>200+ hours of training</p>
            </div> */}
            <div className="flex items-center text-lg text-left mt-3 md:mt-9">
              <div className="text-3xl sm:text-5xl mr-2">
                <FaCheckCircle className="" />
              </div>
              <p>100% Job Assistance to all the Students</p>
            </div>
            <div className="flex items-center text-lg text-left mt-3 md:mt-9">
              <div className="text-3xl sm:text-5xl mr-2">
                <FaCheckCircle className="" />
              </div>
              <p>Practical Assignment with Hand Holding Support</p>
            </div>
            <div className="flex items-center text-lg text-left mt-3 md:mt-9">
              <div className="text-3xl sm:text-5xl mr-2">
                <FaCheckCircle className="" />
              </div>
              <p>100% Job Placement By Jobwala99.com</p>
            </div>
          </div>
        </div>
      </section>
